...
function safeAuthDiagnostics(value) {
  ...
  return {
    ...
    knownPageConfigured: Boolean(value.knownPageConfigured),
    knownPageAttempted: Boolean(value.knownPageAttempted),
    knownPageHasInstagram: Boolean(value.knownPageHasInstagram),
    knownPageAccessTokenReturned: Boolean(value.knownPageAccessTokenReturned),
